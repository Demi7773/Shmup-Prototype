...
{
    public class TheTrustyRevolver : Weapon
    {

        [Space(30)]
        [Header("TheTrustyRevolver")]
        [Header("Pool")]
        ...
        [SerializeField] protected float _baseDamage = 30.0f;
        [SerializeField] protected float _baseTimeBetweenShots = 0.25f;
        [SerializeField] protected float _baseReloadDuration = 1.3f;
        [SerializeField] protected float _baseAimOffset = 6.0f;
        [Space(30)]
        [Header("Debug")]
        ...
        public override void Init(PlayerReferences playerRef)
        {
            ...
            //_shootVFX = _playerWeapons.RevolverVFX;
